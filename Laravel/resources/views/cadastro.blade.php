    ...
    <form class="formulario" method="post">
        ...
        <div class="flex sexo-idade">
            ...
            <div class="field">
                ...
                <input type="date" id="dataNascimento" name="dataNascimento" placeholder="Digite sua data de nascimento"
                    required>
            </div>
        </div>
        <div class="cpf">
        ...
        <div class="flex acesso-email">
            ...
            <div class="field">
                ...
                <input type="email" id="email_confirmation" name="email_confirmation" placeholder="Confirme seu email"
                    required>
            </div>
        </div>
